            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        {{-- <div class="btn-group">
                            <button type="button" class="btn btn-light dropdown-toggle" data-toggle="dropdown" aria-expanded="false"></button>
                        ...
                        <div class="btn-group ml-auto">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{route('user#detailChangePage')}}">Account</a></li>
                                <li>
                                    <form action="{{ route('logout') }}" method="post" class="">
                                        @csrf
                                        <button type="submit" class="btn btn-secondary text-black w-100 my-1">
                                ...
                                <li>
                                    <a href="{{ route('user#changePasswordPage') }}" class=" text-decoration-none">
                                        <button type="submit"
                                            class="btn btn-secondary text-black d-inline w-100 my-1"><i
