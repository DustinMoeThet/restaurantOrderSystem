                ...
                <div class="col-md-12">
                    ...
                    <div class="text-end row">
                        <div class="col-4 my-3 ml-auto">
                            <form action="<?php echo e(route('admin#list')); ?>" method="get">
                                <?php echo csrf_field(); ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="tr-shadow my-1">
                                        ...
                                        <td>
                                            <?php if(Auth::user()->id == 1 && Auth::user()->id != $item->id): ?>
                                                <div class="table-data-feature mb-3">
                                                    <a href="<?php echo e(route('admin#changeRole', $item->id)); ?>">
                                                ...
                                                <div class="table-data-feature">
                                                    <a href="<?php echo e(route('admin#delete', $item->id)); ?>">
                                                        <button class="item" data-toggle="tooltip" data-placement="top"
                                                            title="Delete">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PizzaOrderProject\pizza_order_system\resources\views/admin/account/list.blade.php ENDPATH**/ ?>