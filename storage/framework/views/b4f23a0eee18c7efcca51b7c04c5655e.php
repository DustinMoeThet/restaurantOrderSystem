                ...
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <?php $__currentLoopData = $cartList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="align-middle"><?php echo e($item->product_name); ?>

                                    <input type="hidden" name="productId" class="productId" value="<?php echo e($item->product_id); ?>">
                                    <input type="hidden" name="userId" class="userId" value="<?php echo e($item->user_id); ?>">
                                </td>
                                <td class="align-middle">
                                    <p id="productPrice" class=" d-inline"><?php echo e($item->product_price); ?></p> Kyat
                                </td>
                                <td class="align-middle">
                                ...
                                <td class="align-middle">
                                    <p class="d-inline" id="total"><?php echo e($item->product_price * $item->qty); ?></p> Kyat
                                </td>
                                <td class="align-middle">
                                    <a href="<?php echo e(route('user#cartListDelete', $item->cart_id)); ?>">
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="border-bottom pb-2">
                        <div class="d-flex justify-content-between mb-3">
                            <h6>Subtotal</h6>
                            <div>
                                <h6 class=" d-inline" id="allTotal" all><?php echo e($totalPrice); ?></h6>
                    ...
                    <div class="pt-2">
                        <div class="d-flex justify-content-between mt-2">
                            <h5>Total</h5>
                            <h5 id="finalTotal"><?php echo e($totalPrice + 3000); ?></h5>
                        </div>

                        <button id="orderBtn" class="btn btn-block btn-primary font-weight-bold my-3 py-3">Proceed To
                            Checkout
                        </button>
                        <a href="<?php echo e(route('user#cartDelete')); ?>" class="text-decoration-none">
...
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PizzaOrderProject\pizza_order_system\resources\views/user/main/cart.blade.php ENDPATH**/ ?>