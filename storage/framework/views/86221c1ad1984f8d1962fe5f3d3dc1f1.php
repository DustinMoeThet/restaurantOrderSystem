                            ...
                            <tbody>
                                <?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="tr-shadow my-1">
                                        ...
                                        <td class=" text-center"><?php echo e($item->order_code); ?></td>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('admin#orderDetail', $item->order_code)); ?>">
        ...
        $(document).ready(function() {
            $('#orderStatus').change(function() {
                ...
                <tr class="tr-shadow my-1">
                    ...
                    <td>
                        <a href="<?php echo e(url('http://localhost:8000/order/detail/${order.order_code}')); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PizzaOrderProject\pizza_order_system\resources\views/admin/orders/list.blade.php ENDPATH**/ ?>