...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="register-link">
            <p>
                ...
                <a href="<?php echo e(route('auth#loginPage')); ?>">Sign In</a>
            </p>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PizzaOrderProject\pizza_order_system\resources\views/register.blade.php ENDPATH**/ ?>